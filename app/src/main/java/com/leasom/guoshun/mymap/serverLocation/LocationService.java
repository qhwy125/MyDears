    ...
    AMapLocationListener locationListener = new AMapLocationListener() {
        ...
        private void sendLocationBroadcast(AMapLocation aMapLocation) {
           /* //记录信息并发送广播
            ...
            mIntent.putExtra("latiude",aMapLocation.getLatitude());
            mIntent.putExtra("citycode",  aMapLocation.getCityCode());
            mIntent.putExtra("cityname",  aMapLocation.getCity());
            mIntent.putExtra("district",  aMapLocation.getDistrict());
            mIntent.putExtra("address",  aMapLocation.getAddress());
            mIntent.putExtra("street",  aMapLocation.getStreet());
            //发送广播
